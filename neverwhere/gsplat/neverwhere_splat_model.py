# needs gsplat 1.4.0 (nerfstudio-project/gsplat@ec3e715), see README
import os
import numpy as np
import torch
...
class RenderCfg:
    ...
    packed: bool = False  # less memory, slightly slower
    ...
    def rasterize_splats(
        ...
        **kwargs,
        ...
        render_colors, render_alphas, info = rasterization(
            ...
            absgrad=True,  # what the training strategy used; only matters for gradients
